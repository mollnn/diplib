...
void Widget::_render()
{
    ...
    Img<uint8_t> img_tmp = Img<uint16_t>(Img<uint16_t>(img_in_.gaussianBlur(0.12))._unsharpMasking(kernel, -5)).applyGrayWindow<uint8_t>(gray_window_breadth_, gray_window_position_);
