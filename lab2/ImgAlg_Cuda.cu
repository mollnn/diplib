...
extern "C" void __ImgAlgInterp_interpBilinear_cuda_epi8(uint8_t *dest_ptr, uint8_t *src_ptr, float *x_coords, float *y_coords, int dest_width, int dest_height, int src_width, int src_height, uint8_t default_value)
{
...
extern "C" void __ImgAlgInterp_interpBilinear_cuda_epi16(uint16_t *dest_ptr, uint16_t *src_ptr, float *x_coords, float *y_coords, int dest_width, int dest_height, int src_width, int src_height, uint16_t default_value)
{
...
extern "C" void __ImgAlgAffine_affineTransform_cuda_epi8(uint8_t *dest_ptr, uint8_t *src_ptr, float *mat, int dest_width, int dest_height, int src_width, int src_height, uint8_t default_value)
{
...
extern "C" void __ImgAlgAffine_affineTransform_cuda_epi16(uint16_t *dest_ptr, uint16_t *src_ptr, float *mat, int dest_width, int dest_height, int src_width, int src_height, uint16_t default_value)
{
